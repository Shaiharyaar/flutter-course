...
class FilteredFavoriteRecipesList extends ConsumerStatefulWidget {
  const FilteredFavoriteRecipesList({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _FilteredFavRecipesScreenState createState() =>
      _FilteredFavRecipesScreenState();
}

class _FilteredFavRecipesScreenState
    extends ConsumerState<FilteredFavoriteRecipesList> {
  ...
  Future<void> _fetchPage(int pageKey) async {
    ...
    try {
      Query query = _firestore
          .collection('recipes')
          .where('favorite', arrayContains: user!.uid)
          .orderBy('title')
          .limit(_pageSize);
